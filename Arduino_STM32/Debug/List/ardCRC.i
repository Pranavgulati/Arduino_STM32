...
void crc::begin()
{
  ...
  RCC_AHBPeriphClockCmd(((uint32_t)0x00000040), ENABLE);
  ...
  CRC_ReverseInputDataSelect(((uint32_t)0x00000000));
...
void crc::begin(uint32_t poly)
{
  ...
  CRC_ReverseInputDataSelect(((uint32_t)0x00000060));
...
void crc::stop(){
RCC_AHBPeriphClockCmd(((uint32_t)0x00000040), DISABLE);
