...
typedef struct {
	...
	uint8_t bNumConfigurations;
	uint8_t bReserved;
} __packed USB_DeviceQualifierDescriptor;
...
typedef struct {
	...
	uint8_t bMaxPower;
} __packed USB_ConfigurationDescriptor;
...
typedef struct {
	...
	uint8_t iInterface;
} __packed USB_InterfaceDescriptor;
...
typedef struct {
	...
	uint8_t iFunction;
} __packed USB_InterfaceAssociationDescriptor;
...
typedef struct {
	...
	uint8_t bInterval;
} __packed USB_EndpointDescriptor;

typedef struct {
	uint8_t bLength;
	uint8_t bDescriptorType;
	uint16_t *bString;
} __packed USB_StringDescriptor;
...
typedef struct {
	...
	uint8_t reserved2[6];
} __packed USB_MicrosoftCompatibleDescriptor_Interface;
...
} __packed USB_MicrosoftCompatibleDescriptor;